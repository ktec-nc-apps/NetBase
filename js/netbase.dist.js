...
const _hoisted_696 = { class: "devwin-line" }
const _hoisted_697 = {
  key: 1,
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
      ...
      return (_openBlock(), _createElementBlock("div", {
        ...
        (w.help)
          ? (_openBlock(), _createElementBlock("div", {
              ...
              }, _toDisplayString(_ctx.t('Close')), 9 /* TEXT, PROPS */, _hoisted_695)
            ], 32 /* NEED_HYDRATION */))
          : _createCommentVNode("v-if", true),
        _createElementVNode("div", _hoisted_696, _toDisplayString(_ctx.t('{host} — its own settings page, opened through this server, so it works from anywhere. Sign in and change settings as you would standing in front of it.', { host: w.base.replace(/^https?:\/\//, '') })), 1 /* TEXT */),
        (w.busy)
    ...
    (_ctx.selected)
      ? (_openBlock(), _createElementBlock("div", {
          ...
          onClick: _cache[263] || (_cache[263] = _withModifiers($event => (_ctx.selected=null), ["self"]))
        }, [
              ...
              _createElementVNode("div", _hoisted_824, [
                ...
                (_ctx.allowed('ping'))
                  ? (_openBlock(), _createElementBlock("button", {
                      key: 0,
                      class: "btn sm",
                      onClick: _cache[256] || (_cache[256] = $event => (_ctx.toolFor('ping')))
                ...
                (_ctx.allowed('ports'))
                  ? (_openBlock(), _createElementBlock("button", {
                      key: 1,
                      class: "btn sm",
                      onClick: _cache[257] || (_cache[257] = $event => (_ctx.toolFor('ports')))
                ...
                (_ctx.allowed('nmap') && _ctx.status.nmap && _ctx.status.nmap.available)
                  ? (_openBlock(), _createElementBlock("button", {
                      key: 2,
                      class: "btn sm",
                      onClick: _cache[258] || (_cache[258] = $event => (_ctx.toolFor('nmap')))
                    }, "🗺️ nmap"))
                  : _createCommentVNode("v-if", true),
                (_ctx.selected.mac && _ctx.allowed('wol'))
                  ? (_openBlock(), _createElementBlock("button", {
                      key: 3,
                      class: "btn sm",
                      onClick: _cache[259] || (_cache[259] = $event => (_ctx.wake(_ctx.selected)))
            ...
            _createElementVNode("div", _hoisted_828, [
              (_ctx.allowed('scan'))
                ? (_openBlock(), _createElementBlock("button", {
                    key: 0,
                    class: "btn danger sm",
                    onClick: _cache[260] || (_cache[260] = $event => (_ctx.removeDevice(_ctx.selected)))
                  }, _toDisplayString(_ctx.t('Forget this device')), 1 /* TEXT */))
                : _createCommentVNode("v-if", true),
              _hoisted_829,
              _createElementVNode("button", {
                class: "btn sm",
                onClick: _cache[261] || (_cache[261] = $event => (_ctx.selected=null))
              }, _toDisplayString(_ctx.allowed('scan') ? _ctx.t('Cancel') : _ctx.t('Close')), 1 /* TEXT */),
              (_ctx.allowed('scan'))
                ? (_openBlock(), _createElementBlock("button", {
                    key: 1,
                    class: "btn primary",
                    onClick: _cache[262] || (_cache[262] = (...args) => (_ctx.saveDevice && _ctx.saveDevice(...args)))
