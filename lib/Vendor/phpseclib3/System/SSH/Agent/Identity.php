...
namespace OCA\NetBase\Vendor\phpseclib3\System\SSH\Agent;
...
use OCA\NetBase\Vendor\phpseclib3\System\SSH\Common\Traits\ReadBytes;

/**
 * Pure-PHP ssh-agent client identity object
 *
 * Instantiation should only be performed by \OCA\NetBase\Vendor\phpseclib3\System\SSH\Agent class.
 * This could be thought of as implementing an interface that OCA\NetBase\Vendor\phpseclib3\Crypt\RSA
...
class Identity implements PrivateKey
{
     ...
     * Set Public Key
     *
     * Called by \OCA\NetBase\Vendor\phpseclib3\System\SSH\Agent::requestIdentities()
     *
     * @param PublicKey $key
     */
     ...
     * Set Public Key
     *
     * Called by \OCA\NetBase\Vendor\phpseclib3\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key
