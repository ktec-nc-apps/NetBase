 ...
 * <code>
 * <?php
 *    $a = new \OCA\NetBase\Vendor\phpseclib3\Math\BigInteger(2);
 *    $b = new \OCA\NetBase\Vendor\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace OCA\NetBase\Vendor\phpseclib3\Math;

use OCA\NetBase\Vendor\phpseclib3\Exception\BadConfigurationException;
use OCA\NetBase\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'OCA\NetBase\Vendor\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \OCA\NetBase\Vendor\phpseclib3\Math\BigInteger('10');
     *    $b = new \OCA\NetBase\Vendor\phpseclib3\Math\BigInteger('20');
     *
