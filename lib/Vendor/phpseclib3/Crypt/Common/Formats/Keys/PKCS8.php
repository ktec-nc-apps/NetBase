...
namespace OCA\NetBase\Vendor\phpseclib3\Crypt\Common\Formats\Keys;

use OCA\NetBase\Vendor\phpseclib3\Common\Functions\Strings;
use OCA\NetBase\Vendor\phpseclib3\Crypt\AES;
use OCA\NetBase\Vendor\phpseclib3\Crypt\DES;
use OCA\NetBase\Vendor\phpseclib3\Crypt\Random;
use OCA\NetBase\Vendor\phpseclib3\Crypt\RC2;
use OCA\NetBase\Vendor\phpseclib3\Crypt\RC4;
use OCA\NetBase\Vendor\phpseclib3\Crypt\TripleDES;
...
abstract class PKCS8 extends PKCS
{
     ...
     *
     * @return \OCA\NetBase\Vendor\phpseclib3\Crypt\Common\SymmetricKey
     * @param string $algo
     */
