 ...
 *
 * $private = \OCA\NetBase\Vendor\phpseclib3\Crypt\EC::createKey('secp256k1');
...
namespace OCA\NetBase\Vendor\phpseclib3\Crypt;

use OCA\NetBase\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\Curve25519;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\Curve448;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\Ed25519;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\Ed448;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Formats\Keys\PKCS8;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Parameters;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\PrivateKey;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\PublicKey;
use OCA\NetBase\Vendor\phpseclib3\Exception\BadConfigurationException;
...
use OCA\NetBase\Vendor\phpseclib3\Exception\UnsupportedOperationException;
use OCA\NetBase\Vendor\phpseclib3\File\ASN1;
use OCA\NetBase\Vendor\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\\' . $curveName;
