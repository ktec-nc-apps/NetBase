 ...
 *
 *    $rijndael = new \OCA\NetBase\Vendor\phpseclib3\Crypt\Rijndael('ctr');
 *
...
class Rijndael extends BlockCipher
{
     ...
     * \OCA\NetBase\Vendor\phpseclib3\Crypt\Rijndael determines automatically whether mcrypt is useable
