 ...
 *
 *    $des = new \OCA\NetBase\Vendor\phpseclib3\Crypt\TripleDES('ctr');
 *
...
class TripleDES extends DES
{
     ...
     *
     * Outer chaining is used by SSH-2 and when the mode is set to \OCA\NetBase\Vendor\phpseclib3\Crypt\Common\BlockCipher::MODE_CBC.
     */
    ...
    /**
     * The \OCA\NetBase\Vendor\phpseclib3\Crypt\DES objects
     *
    ...
    public function __construct($mode)
    {
        switch (strtolower($mode)) {
            ...
            case '3cbc':
                ...
                // we're going to be doing the padding, ourselves, so disable it in the \OCA\NetBase\Vendor\phpseclib3\Crypt\DES objects
     ...
     *
     * This is mainly just a wrapper to set things up for \OCA\NetBase\Vendor\phpseclib3\Crypt\Common\SymmetricKey::isValidEngine()
     *
     * @see Common\SymmetricKey::__construct()
     * @param int $engine
     * @return bool
     ...
     *
     * SetIV is not required when \OCA\NetBase\Vendor\phpseclib3\Crypt\Common\SymmetricKey::MODE_ECB is being used.
     *
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \OCA\NetBase\Vendor\phpseclib3\Crypt\DES() object changes after each
