...
use OCA\NetBase\Vendor\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
...
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\secp256k1;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\secp256r1;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\secp384r1;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     * @param \OCA\NetBase\Vendor\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
