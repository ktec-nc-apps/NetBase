...
namespace OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Formats\Keys;

use OCA\NetBase\Vendor\phpseclib3\Common\Functions\Strings;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\Binary as BinaryCurve;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\Montgomery;
use OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
...
trait Common
{
    ...
    /**
     * Returns an instance of \OCA\NetBase\Vendor\phpseclib3\Crypt\EC\BaseCurves\Base based
    ...
    protected static function loadCurveByParam(array $params)
    {
        ...
        if (isset($params['namedCurve'])) {
            $curve = '\OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\\' . $params['namedCurve'];
    ...
    private static function encodeParameters(BaseCurve $curve, $returnArray = false, array $options = [])
    {
        ...
        if ($useNamedCurves) {
            ...
            foreach (new \DirectoryIterator(__DIR__ . '/../../Curves/') as $file) {
                ...
                $class = 'OCA\NetBase\Vendor\phpseclib3\Crypt\EC\Curves\\' . $testName;
