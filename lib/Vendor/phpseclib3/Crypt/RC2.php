 ...
 *
 *    $rc2 = new \OCA\NetBase\Vendor\phpseclib3\Crypt\RC2('ctr');
 *
 *    $rc2->setKey('abcdefgh');
 *
...
use OCA\NetBase\Vendor\phpseclib3\Crypt\Common\BlockCipher;
...
class RC2 extends BlockCipher
{
     ...
     *  \OCA\NetBase\Vendor\phpseclib3\Crypt\RC2::setKey() call.
     *
     ...
     * Encrypts a message.
     *
     * Mostly a wrapper for \OCA\NetBase\Vendor\phpseclib3\Crypt\Common\SymmetricKey::encrypt, with some additional OpenSSL handling code
     *
     * @see self::decrypt()
     ...
     * Decrypts a message.
     *
     * Mostly a wrapper for \OCA\NetBase\Vendor\phpseclib3\Crypt\Common\SymmetricKey::decrypt, with some additional OpenSSL handling code
     *
     * @see self::encrypt()
    ...
    protected function setupKey()
    {
        ...
        // Key has already been expanded in \OCA\NetBase\Vendor\phpseclib3\Crypt\RC2::setKey():
