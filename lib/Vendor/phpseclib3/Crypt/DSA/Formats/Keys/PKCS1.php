...
namespace OCA\NetBase\Vendor\phpseclib3\Crypt\DSA\Formats\Keys;
...
abstract class PKCS1 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        // included. eg. \OCA\NetBase\Vendor\phpseclib3\File\ASN1\Maps\SubjectPublicKeyInfo has "algorithm" and
