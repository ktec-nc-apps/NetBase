...
namespace OCA\NetBase\Vendor\phpseclib3\Common\Functions;

use ParagonIE\ConstantTime\Base64;
use ParagonIE\ConstantTime\Base64UrlSafe;
use ParagonIE\ConstantTime\Hex;
use OCA\NetBase\Vendor\phpseclib3\Math\BigInteger;
use OCA\NetBase\Vendor\phpseclib3\Math\Common\FiniteField;
            ...
            switch ($format[$i]) {
                ...
                case 'i':
                    if (!$element instanceof BigInteger && !$element instanceof FiniteField\Integer) {
                        throw new \InvalidArgumentException('A OCA\NetBase\Vendor\phpseclib3\Math\BigInteger or OCA\NetBase\Vendor\phpseclib3\Math\Common\FiniteField\Integer object was expected.');
                    }
